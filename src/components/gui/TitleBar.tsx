...
const TitleBar: React.FC = () => {
  const history = window.pageHistory || [];
  ...
  return (
    <div className="title-bar unselectable">
      <div
        className="title-bar-back button-title-bar"
      ...
      <div className="title-bar-text unselectable">AniDesk <sup>β</sup></div>
      <button
        className="title-bar-minimize button-title-bar"
        onClick={() => window.titleBarAPI?.minimize()}
      >
        <svg
          aria-hidden="true"
          role="img"
      ...
      <button
        ...
        onClick={() => window.titleBarAPI?.maximize()}
      >
        <svg
          aria-hidden="true"
          role="img"
